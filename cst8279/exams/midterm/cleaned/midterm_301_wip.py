...
def get_weight_of_assignments():
    ...
    return _get_input_float("Please enter the weight of assignments", 0, 100, 0.4)
...
def get_weight_of_midterms():
    ...
    return _get_input_float("Please enter the weight of midterms", 0, 100, 0.35)
...
def get_weight_of_finals():
    ...
    return _get_input_float("Please enter the weight of finals", 0, 100, 0.25)
